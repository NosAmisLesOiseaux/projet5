...
class BirdController extends Controller
{
     ...
     * @return Response
     */
    public function showBirdsByRegionAndLetterAction(Request $request, NAOBirdManager $naoBirdManager, NAOPagination $naoPagination, NAOCountBirds $naoCountBirds, $page)
    {
        $regions = json_decode(file_get_contents("https://geo.api.gouv.fr/regions"), true);
