...
// tests/Service/Map/NAOShowMapTest.php
...
class NAOShowMapTest extends WebTestCase
{
    ...
    protected function setUp()
    {
        ...
        $this->lastCaptures = $this->naoCaptureManager->getLastPublishedCaptures();
	...
	public function testFormatCapture()
	{
		...
		$this->assertSame(200, $this->client->getResponse()->getStatusCode());
		$this->assertSame('application/json', $response->headers->get('Content-Type'));
		$this->assertEquals('[{"id":1,"latitude":48.70981,"longitude":2.041563}]', $response->getContent());
		$this->assertNotEmpty($this->client->getResponse()->getContent());
	}
