...
// tests/Controller/Backend/AdminSpaceControllerTest.php

namespace App\tests\Controller\Backend;
...
class AdminSpaceControllerTest extends WebTestCase
{
    public function testShowAdminSpace()
    {
        ...
        $crawler = $client->request('GET', '/espace-administration/');
    ...
    public function testIgnoreReportedComment()
    {
        ...
        $crawler = $client->request('GET', '/ignorer-commentaire-signale/4');
    ...
    public function testRemoveComment()
    {
        ...
        $crawler = $client->request('GET', '/supprimer-commentaire/4');
